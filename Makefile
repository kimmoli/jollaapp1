...
Makefile: testi1.pro /usr/share/qt5/mkspecs/linux-g++/qmake.conf /usr/share/qt5/mkspecs/features/spec_pre.prf \
		/usr/share/qt5/mkspecs/common/shell-unix.conf \
		/usr/share/qt5/mkspecs/common/unix.conf \
		/usr/share/qt5/mkspecs/common/linux.conf \
		/usr/share/qt5/mkspecs/common/gcc-base.conf \
...
dist: 
	@test -d obj/testi11.0.0 || mkdir -p obj/testi11.0.0
	$(COPY_FILE) --parents $(SOURCES) $(DIST) obj/testi11.0.0/ && $(COPY_FILE) --parents src/testi1.cpp obj/testi11.0.0/ && (cd `dirname obj/testi11.0.0` && $(TAR) testi11.0.0.tar testi11.0.0 && $(COMPRESS) testi11.0.0.tar) && $(MOVE) `dirname obj/testi11.0.0`/testi11.0.0.tar.gz . && $(DEL_FILE) -r obj/testi11.0.0
...
obj/testi1.o: src/testi1.cpp /usr/include/qt5/QtQuick/QtQuick \
	...
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o obj/testi1.o src/testi1.cpp
...
install_qml: first FORCE
	@test -d $(INSTALL_ROOT)/usr/share/testi1 || mkdir -p $(INSTALL_ROOT)/usr/share/testi1
	-$(INSTALL_DIR) /home/mersdk/SailfishProjects/testi1/qml $(INSTALL_ROOT)/usr/share/testi1/

uninstall_qml: FORCE
	-$(DEL_FILE) -r $(INSTALL_ROOT)/usr/share/testi1/qml
	-$(DEL_DIR) $(INSTALL_ROOT)/usr/share/testi1/ 


install_desktop: first FORCE
	@test -d $(INSTALL_ROOT)/usr/share/applications || mkdir -p $(INSTALL_ROOT)/usr/share/applications
	-$(INSTALL_PROGRAM) /home/mersdk/SailfishProjects/testi1/testi1.desktop $(INSTALL_ROOT)/usr/share/applications/
	-: $(INSTALL_ROOT)/usr/share/applications/testi1.desktop

uninstall_desktop: FORCE
	-$(DEL_FILE) -r $(INSTALL_ROOT)/usr/share/applications/testi1.desktop
...
install_icon: first FORCE
	...
	-$(INSTALL_PROGRAM) /home/mersdk/SailfishProjects/testi1/testi1.png $(INSTALL_ROOT)/usr/share/icons/hicolor/90x90/apps/
	-: $(INSTALL_ROOT)/usr/share/icons/hicolor/90x90/apps/testi1.png

uninstall_icon: FORCE
	-$(DEL_FILE) -r $(INSTALL_ROOT)/usr/share/icons/hicolor/90x90/apps/testi1.png
